...
class SideMenuContent extends React.Component {
  ...
  getData() {  
   ...
   // let {userRole}=this.state
    ...
    let _targetPostURL="http://127.0.0.1:3010/api/auth/mymenulist?=";
        ...
        case 91:
          menus=[
            ...
            },
            {
              ...
              target:"_blank",
              icon: <Icon.Activity size={16} />,
              // navLink: "http://127.0.0.1:3010/documents/dump.csv"
            ...
            
            {
              ...
              target:"_blank",
              icon: <Icon.Activity size={16} />,
              // navLink: "http://127.0.0.1:3010/documents/dumpHealth.csv"   
