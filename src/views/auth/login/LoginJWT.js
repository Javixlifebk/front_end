...
class LoginJWT extends React.Component {
  ...
  handleLogin = e => {
    ...
    let _targetPostURL="http://18.60.238.252:3010/api/auth/login?=";
    axios(
      {
        method: 'post',
        url: _targetPostURL,
          ...
          .catch(e=>{
           if(e.response.data.status===0 || e.response.data.status==="0")
                              ...
                              if(e.response.data.message.indexOf("not confirmed")>=0){
                                ...
                                let _itargetPostURL="http://18.60.238.252:3010/api/auth/resend-verify-otp?=";
                                axios(
                                  {
                                    method: 'post',
                                    url: _itargetPostURL,
    ...
    /*var URL="http://18.60.238.252:3010/api/auth/login"
