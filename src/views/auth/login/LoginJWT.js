...
class LoginJWT extends React.Component {
  ...
  handleLogin = e => {
    ...
    // let _targetPostURL="http://159.65.148.197:3010/?=";
    let _targetPostURL="http://159.65.148.197:3010/api/auth/login?=";
    axios(
      {
        method: 'post',
        url: _targetPostURL,
              ...
              if(res.data.status===1 || res.data.status==="1")
                { 
                 ...
                 axios(
                  {
                    method: 'post',
                    url: 'http://159.65.148.197:3010/api/login/getjavixid?=',
          ...
          .catch(e=>{
           if(e.response.data.status===0 || e.response.data.status==="0")
                              ...
                              if(e.response.data.message.indexOf("not confirmed")>=0){
                                ...
                                let _itargetPostURL="http://159.65.148.197:3010/api/auth/resend-verify-otp?=";
                                axios(
                                  {
                                    method: 'post',
                                    url: _itargetPostURL,
    ...
    /*var URL="http://159.65.148.197:3010/api/auth/login"
