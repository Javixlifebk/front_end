...
// if(ngo){
 findDataById(){
  ...
  axios.post('http://localhost:3010/api/ngo/ngoFindbyId',{ngoLoginId:localStorage.getItem("userid")})
  .then(response => {
    if(response){
  ...
  handleSubmit = e => {
    ...
    var myCurrentDate = new Date();
      ...
      axios.post("http://localhost:3010/api/logo/addbanner", formData, { 
      ...
      let _targetPostURL="http://localhost:3010/api/ngo/addprofile?=";
      axios(
        {
          method: 'post',
          url: _targetPostURL,
