...
// if(ngo){
 findDataById(){
  ...
  axios.post('http://127.0.0.1:3010/api/ngo/ngoFindbyId',{ngoLoginId:localStorage.getItem("userid")})
  .then(response => {
    if(response){
  ...
  handleSubmit = e => {
    ...
    var myCurrentDate = new Date();
      ...
      axios.post("http://127.0.0.1:3010/api/logo/addbanner", formData, { 
      ...
      let _targetPostURL="http://127.0.0.1:3010/api/ngo/addprofile?=";
      axios(
        {
          method: 'post',
          url: _targetPostURL,
