...
class RegisterPharmacy extends React.Component {
  ...
  handleRegister = e => {
    ...
    let _targetPostURL="http://localhost:3001/api/auth/register?=";
    axios(
      {
        method: 'post',
        url: _targetPostURL,
        ...
        headers: {'Content-Type': 'application/x-www-form-urlencoded' }
          ...
          .catch((e)=>{
           //console.dir("Exception:" + e.response.data.data);
           //console.dir(e)
  ...
  render() {
    ...
    return (
      <Form action="#" onSubmit={this.handleRegister}>
        ...
        <div style={{color:"#00000",fontWeight:"bold"}}>Sevika Registration Form</div>
        </FormGroup>
        <FormGroup className="form-label-group">
