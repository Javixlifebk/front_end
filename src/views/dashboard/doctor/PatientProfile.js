...
class PatientProfile extends React.Component {
  ...
  componentDidMount() {
		...
		axios.post('http://127.0.0.1:3010/api/citizen/citizenList?=', { citizenId: localStorage.getItem("citizenId"),token:'dfjkhsdfaksjfh3756237',ngoId: localStorage.getItem("ngoId") })
		 .then(response => {
