...
class PatientProfile extends React.Component {
  ...
  componentDidMount() {
		...
		axios.post('https://javixlife.org:3010/api/citizen/citizenList?=', { citizenId: localStorage.getItem("citizenId"),token:'dfjkhsdfaksjfh3756237',ngoId: localStorage.getItem("ngoId") })
		 .then(response => {
