...
function CustomToolbar() {
  // http://143.244.136.145:3001/api/screening/updateCase
  return (
...
function ReferPatientList() {
  ...
  const handleClick=(caseId)=> {
    ...
    let _targetPostURL="http://143.244.136.145:3001/api/screening/updateCase?=";
    axios(
      {
        method: 'post',
        url: _targetPostURL,
  ...
  useEffect(() => {
		  axios.post('http://143.244.136.145:3001/api/citizen/citizenrefer', {token:'dfjkhsdfaksjfh3756237',isUnrefer:true })
		 .then(response => {
