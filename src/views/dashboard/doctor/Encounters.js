...
class PatientList extends React.Component {
   ...
   downloadReport(caseId){
     ...
     //String url="http://143.244.136.145:3001/api/report/createCaseReport";

     
     var _url="http://google.co.in";
     /*axios.post('http://143.244.136.145:3001/api/report/createCaseReport?=', { caseId:caseId,token:'dfjkhsdfaksjfh3756237' })
		 .then(response => {
...
componentDidMount() {
		...
		//this.setState({data:null});
		  axios.post('http://143.244.136.145:3001/api/screening/getEncounters?=', { citizenId:localStorage.getItem("citizenId"),token:'dfjkhsdfaksjfh3756237' })
		 .then(response => {
					if(response.data.status===1)
					  {
						  var msg=response.data.message;
     ...
     axios.post('http://143.244.136.145:3001/api/report/createCaseReport?=', { caseId:localStorage.getItem("caseId"),token:'dfjkhsdfaksjfh3756237' })
    .then(response => {
