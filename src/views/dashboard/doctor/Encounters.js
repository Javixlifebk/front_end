...
class PatientList extends React.Component {
   ...
   downloadReport(caseId){
     ...
     /*axios.post('http://18.60.238.252:3010/api/report/createCaseReport?=', { caseId:caseId,token:'dfjkhsdfaksjfh3756237' })
		 .then(response => {
...
componentDidMount() {
		...
		//this.setState({data:null});
		  axios.post('http://18.60.238.252:3010/api/screening/getEncounters?=', { citizenId:localStorage.getItem("citizenId"),ngoId:localStorage.getItem("ngoId"),token:'dfjkhsdfaksjfh3756237' })
		 .then(response => {
					if(response.data.status===1)
					  {
						  var msg=response.data.message;
     ...
     axios.post('http://18.60.238.252:3010/api/report/createCaseReport?=', { caseId:localStorage.getItem("caseId"),token:'dfjkhsdfaksjfh3756237' })
    .then(response => {
