...
import {CardHeader, CardTitle, CardImg, Button, Progress} from 'reactstrap';
...
class DoctorDashboard extends React.Component {
  ...
  componentDidMount () {
    ...
    axios
      .post ('http://143.244.136.145:3001/api/graph/getlist', {
        ...
        <Row className="match-height" style={{textAlign: 'center'}}>
          <Col>
            <Card>
              ...
              <CardBody>
                <a href="/dashboard/admin/doctorlist">
                {/* // target="_blank"
                  Doctors */}
                </a>
              </CardBody>
              <CardBody>
                <a href="/dashboard/admin/screenerlist">
                {/* // target="_blank"
                  Screener */}
                </a>
              </CardBody>
              <CardBody>
                <a href="/dashboard/admin/ngolist">
                {/* // target="_blank" */}
                  {/* NGO */}
                </a>
              </CardBody>
