...
class AddMedicine extends React.Component {
  ...
  prescribeData(){
    ...
    axios.post('http://127.0.0.1:3010/api/citizen/citizenReferList', {isUnrefer:2,citizenId:localStorage.getItem("citizenId")})
    .then(response => {
  ...
  handleSubmit = e => {
    e.preventDefault()  
      ...
      let _targetPostURL="http://127.0.0.1:3010/api/doctor/addprescription?=";
      axios(
        {
          method: 'post',
          url: _targetPostURL,
