...
class AddMedicine extends React.Component {
  ...
  prescribeData(){
    ...
    axios.post('https://javixlife.org:3010/api/citizen/citizenReferList', {isUnrefer:2,citizenId:localStorage.getItem("citizenId")})
    .then(response => {
  ...
  handleSubmit = e => {
    e.preventDefault()  
      ...
      let _targetPostURL="https://javixlife.org:3010/api/doctor/addprescription?=";
      axios(
        {
          method: 'post',
          url: _targetPostURL,
