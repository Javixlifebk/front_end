...
class DataCount extends React.Component {
  ...
  //this.setState({data:null});
    ...
    axios.post('http://159.65.148.197:3010/api/screening/getCaseDetails', { doctorId:localStorage.getItem("usermasid") })
   .then(response => {
  ...
  axios.post('http://159.65.148.197:3010/api/screening/getCaseDetails', { doctorId: localStorage.getItem("usermasid"),status:'2' })
  .then(response => {
 ...
 axios.post('http://159.65.148.197:3010/api/screening/getCaseDetails', { doctorId: localStorage.getItem("usermasid"),status:'3' })
  .then(response => {
