...
const fetchRecords = (page,size) => {
  axios.post("https://javixlife.org/api/labtest/getRightEyeAmberList" ,{
    "pageNo":page,
    "size":size,
...
const filterData = (data) =>
    ...
    const setBP=(reye)=>{
          return(<span style={{background:'#FFBF00',padding:'4px',color:'white'}}>Right Eye{reye}</span>);
    }
   ...
   const  getCitizenScreener=(_screenerId) =>{
      ...
      },
      {
      ...
      
        {
          ...
          render: (_, record) => (
            ...
            <span style={{margin:'20px;',padding:'4px;'}}>{setBP(record.reye)}</span>&nbsp;&nbsp;
            </p>
            </div>
          ),
        },
    ...
    return (
      <>
       <Row>
      <Col sm="12">
      <CardTitle><b><h3>Right Eye Amber Cases</h3></b> </CardTitle>
      </Col>          
      </Row>
