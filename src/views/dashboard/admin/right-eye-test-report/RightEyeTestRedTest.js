...
const fetchRecords = (page,size) => {
  axios.post("https://javixlife.org/api/labtest/getRightEyeRedList" ,{
    "pageNo":page,
    "size":size,
...
const filterData = (data) =>
    ...
    const setBP=(reye)=>{
      return(<span style={{background:'red',padding:'4px',color:'white'}}>Right Eye:{reye}</span>);
    }
   ...
   const  getCitizenScreener=(_screenerId) =>{
    ...
    return (
      <>
       <Row>
      <Col sm="12">
      <CardTitle><b><h3>Right Eye Red Cases</h3></b> </CardTitle>
      </Col>          
      </Row>
