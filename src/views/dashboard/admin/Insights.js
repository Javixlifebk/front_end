...
class AdminDashboard extends React.Component {
  ...
  componentDidMount() {
    ...
    axios
      .post("http://143.244.136.145:3001/api/screening/getCount", {
        severity_bp: "0",
      })
      .then((response) => {
    ...
    axios
      .post("http://143.244.136.145:3001/api/labtest/getBloodGlucoseTestCount")
      .then((response) => {
    ...
    axios
      .post("http://143.244.136.145:3001/api/labtest/getHemoglobinCount")
      .then((response) => {
        if (response.data.status === 1) {
          for (var i = 0; i < response.data.data.data.length; i++) {
    ...
    axios
      .post("http://143.244.136.145:3001/api/labtest/getCholestCount")
      .then((response) => {
        if (response.data.status === 1) {
          for (var i = 0; i < response.data.data.data.length; i++) {
            if (response.data.data.data[i]._id === 2)
    ...
    axios
      .post("http://143.244.136.145:3001/api/labtest/gettriCount")
      .then((response) => {
        if (response.data.status === 1) {
          for (var i = 0; i < response.data.data.data.length; i++) {
            if (response.data.data.data[i]._id === 2)
    ...
    axios
      .post("http://143.244.136.145:3001/api/labtest/gethdlCount")
      .then((response) => {
        if (response.data.status === 1) {
          for (var i = 0; i < response.data.data.data.length; i++) {
            if (response.data.data.data[i]._id === 2)
    ...
    axios
      .post("http://143.244.136.145:3001/api/labtest/getldlCount")
      .then((response) => {
        if (response.data.status === 1) {
          for (var i = 0; i < response.data.data.data.length; i++) {
            if (response.data.data.data[i]._id === 2)
    ...
    axios
      .post("http://143.244.136.145:3001/api/labtest/getREyeCount")
      .then((response) => {
        if (response.data.status === 1) {
          for (var i = 0; i < response.data.data.data.length; i++) {
            if (response.data.data.data[i]._id === 2)
    ...
    axios
      .post("http://143.244.136.145:3001/api/labtest/getLEyeCount")
      .then((response) => {
        if (response.data.status === 1) {
          for (var i = 0; i < response.data.data.data.length; i++) {
            if (response.data.data.data[i]._id === 2)
    ...
    axios
      .post("http://143.244.136.145:3001/api/ngo/screenerList?=", {
...
// =============================================================
    ...
    //  ======================================================
    axios.post('http://143.244.136.145:3001/api/labtest/getBloodGlucoseTestList', {severity:'1' })
    .then(response => {
        ...
        <Row className="match-height" style={{ textAlign: "center" }}>
          <Col>
            <Card>
              ...
              <CardBody>
                <a
                  href="http://143.244.136.145:3001/documents/bpRed.csv"
                  target="_blank"
                >
                  {" "}
                  BP Red Cases{" "}
              ...
              <CardBody>
                <a
                  href="http://143.244.136.145:3001/documents/bpAmber.csv"
                  target="_blank"
                >
                  {" "}
                  BP Amber Cases{" "}
              ...
              <CardBody>
                <a
                  href="http://143.244.136.145:3001/documents/bpGreen.csv"
                  target="_blank"
                >
                  {" "}
                  BP Green Cases{" "}
          ...
          <Col>
            <Card>
              ...
              <CardBody>
                <a
                  href="http://143.244.136.145:3001/documents/spo2Red.csv"
                  target="_blank"
                >
                  {" "}
                  SPO2 Red Cases{" "}
              ...
              <CardBody>
                <a
                  href="http://143.244.136.145:3001/documents/spo2Amber.csv"
                  target="_blank"
                >
                  {" "}
                  SPO2 Amber Cases{" "}
              ...
              <CardBody>
                <a
                  href="http://143.244.136.145:3001/documents/spo2Green.csv"
                  target="_blank"
                >
                  {" "}
                  SPO2 Green Cases{" "}
        ...
        <Row className="match-height" style={{ textAlign: "center" }}>
          <Col>
            <Card>
              ...
              <CardBody>
                <a
                  href="http://143.244.136.145:3001/documents/temperatureRed.csv"
                  target="_blank"
                >
                  {" "}
                  TEMP Red Cases{" "}
              ...
              <CardBody>
                <a
                  href="http://143.244.136.145:3001/documents/temperatureAmber.csv"
                  target="_blank"
                >
                  {" "}
                  TEMP Amber Cases{" "}
              ...
              <CardBody>
                <a
                  href="http://143.244.136.145:3001/documents/temperatureGreen.csv"
                  target="_blank"
                >
                  {" "}
                  TEMP Green Cases{" "}
          ...
          <Col>
            <Card>
              ...
              <CardBody>
                <a
                  href="http://143.244.136.145:3001/documents/pulseRed.csv"
                  target="_blank"
                >
                  {" "}
              ...
              <CardBody>
                <a
                  href="http://143.244.136.145:3001/documents/pulseAmber.csv"
                  target="_blank"
                >
                  {" "}
              ...
              <CardBody>
                <a
                  href="http://143.244.136.145:3001/documents/pulseGreen.csv"
                  target="_blank"
                >
                  {" "}
                  HEART RATE Red Cases{" "}
        ...
        <Row className="match-height" style={{ textAlign: "center" }}>
          <Col>
            <Card>
              ...
              <CardBody>
                <a
                  href="http://143.244.136.145:3001/documents/bmiRed.csv"
                  target="_blank"
                >
                  {" "}
                  BMI Red Cases{" "}
              ...
              <CardBody>
                <a
                  href="http://143.244.136.145:3001/documents/bmiAmber.csv"
                  target="_blank"
                >
                  {" "}
                  BMI Amber Cases{" "}
              ...
              <CardBody>
                <a
                  href="http://143.244.136.145:3001/documents/bmiGreen.csv"
                  target="_blank"
                >
                  {" "}
                  BMI Green Cases{" "}
        ...
        {/* <Row>
          <Col>
            <Card>
              ...
              <CardBody>
                <a
                  href="http://143.244.136.145:3001/documents/dump.csv"
                  target="_blank"
                >
                  General Survey
                </a>
              ...
              <CardBody>
                <a
                  href="http://143.244.136.145:3001/documents/dumpHealth.csv"
                  target="_blank"
                >
                  Health Survey
                </a>
              ...
              <CardBody>
                <a
                  href="http://143.244.136.145:3001/documents/dumpSocio.csv"
                  target="_blank"
                >
