...
componentDidMount() {
		...
		axios.post('http://javixlife.org:3010/api/screening/getCaseDetails', {status:'2',  ngoId:(localStorage.getItem("ngoId")) ? localStorage.getItem("ngoId") : localStorage.getItem("userid")})
		 .then(response => {
