...
class LipidPanelcholesterolAmber extends React.Component {
...
componentDidMount() {
    ...
    // if(localStorage.getItem("severity")==="1"){
		  ...
		  axios.post('http://143.244.136.145:3001/api/labtest/LipidPanelCholesterolAmberList')
		 .then(response => {
...
export default LipidPanelcholesterolAmber;
