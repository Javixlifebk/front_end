...
class LipidPaneltriglyAmber extends React.Component {
...
//  }
    ...
    setBP(triglycerides){
        ...
        if(triglycerides>=159 &&  triglycerides<130){
                return(<span style={{background:'#FFBF00',padding:'4px',color:'white'}}>triglycerides:{triglycerides}</span>);
             }else{
            return(<span style={{background:'#FFBF00',padding:'4px',color:'white'}}>triglycerides:{triglycerides}</span>);
         }
    }
...
componentDidMount() {console.log("DID MOUNT ************");
    ...
    // if(localStorage.getItem("severity")==="1"){
		  ...
		  axios.post('http://localhost:3001/api/labtest/LipidPanelTesttriglyceridesAmberList')
		 .then(response => {
...
export default LipidPaneltriglyAmber;
