...
function  LipidPaneltriglyAmber() {
...
axios.post("https://javixlife.org:3010/api/labtest/LipidPaneltriglyAmberList" ,{
  "pageNo":page,
  "size":size,
   ...
   const  getCitizenScreener=(_screenerId) =>{
    ...
    return (
      <>
       <Row>
      <Col sm="12">
      <CardTitle><b><h3>Triglycerides Lipid Panel Amber Cases</h3></b> </CardTitle>
      </Col>          
      </Row>
