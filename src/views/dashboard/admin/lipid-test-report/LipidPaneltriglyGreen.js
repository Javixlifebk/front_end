...
function LipidPaneltriglyGreen() {
...
axios.post("https://javixlife.org:3010/api/labtest/LipidPaneltriglyGreenList" ,{
  "pageNo":page,
  "size":size,
   ...
   const  getCitizenScreener=(_screenerId) =>{
    ...
    return (
      <>
       <Row>
      <Col sm="12">
      <CardTitle><b><h3>Triglycerides Lipid Panel Green Cases</h3></b> </CardTitle>
      </Col>          
      </Row>
