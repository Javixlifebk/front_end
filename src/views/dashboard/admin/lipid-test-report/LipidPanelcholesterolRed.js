...
class LipidPanelcholesterolRed extends React.Component {
...
//  }
    ...
    setBP(cholesterol){
        ...
        if(cholesterol>=160 &&  cholesterol<189 ){
...
componentDidMount() {console.log("DID MOUNT ************");
    ...
    // if(localStorage.getItem("severity")==="1"){
		  ...
		  axios.post('http://159.65.148.197:3001/api/labtest/LipidPanelCholesterolRedList')
		 .then(response => {
