...
class LipidPanelHdlAmber extends React.Component {
...
//  }
    ...
    setBP(hdlcholesterol){
        ...
        if(hdlcholesterol>=159 &&  hdlcholesterol<130){
...
componentDidMount() {console.log("DID MOUNT ************");
    ...
    // if(localStorage.getItem("severity")==="1"){
		  ...
		  axios.post('http://localhost:3001/api/labtest/LipidPanelTesthdlcholesterolAmberList')
		 .then(response => {
