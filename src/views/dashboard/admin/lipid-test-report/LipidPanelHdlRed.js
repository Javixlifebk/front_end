...
class LipidPanelHdlRed extends React.Component {
...
//  }
    ...
    setBP(hdlcholesterol){
        ...
        if(hdlcholesterol>=160 &&  hdlcholesterol<189 ){
      ...
      },
      {
        ...
        cell: row => (
         <div>     
          ...
          <span style={{margin:'20px;',padding:'4px;'}}>{this.setBP(row.hdlcholesterol)}</span>&nbsp;&nbsp;
...
componentDidMount() {console.log("DID MOUNT ************");
    ...
    // if(localStorage.getItem("severity")==="1"){
		  ...
		  axios.post('http://localhost:3001/api/labtest/LipidPanelTesthdlcholesterolRedList')
		 .then(response => {
