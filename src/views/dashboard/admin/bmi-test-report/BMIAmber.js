...
const fetchRecords = (page,size) => {
  axios.post("https://javixlife.org:3010/api/labtest/getBMIAmberList" ,{
    "pageNo":page,
    "size":size,
...
const filterData = (data) =>
    ...
    const setBP=(hemoglobin)=>{
      ...
      if(hemoglobin>13.5 &&  hemoglobin<17.5){
              return(<span style={{background:'#FFBF00',padding:'4px',color:'white'}}>BMI:{hemoglobin}</span>);
           }else{
          return(<span style={{background:'#FFBF00',padding:'4px',color:'white'}}>BMI:{hemoglobin}</span>);
       }
  }
   const  getCitizenScreener=(_screenerId) =>{
    ...
    return (
      <>
       <Row>
      <Col sm="12">
      <CardTitle><b><h3>BMI Amber Cases</h3></b> </CardTitle>
      </Col>          
      </Row>
