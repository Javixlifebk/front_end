...
componentDidMount() {
		...
		//this.setState({data:null});
		 ...
		 axios.post("http://143.244.136.145:3001/api/generalsurvey/screeningScreener")
    //  http://143.244.136.145:3001/api/generalsurvey/screenersevika
		 .then(response => {
  ...
  render() {
    ...
    return (
      <Card>
        <CardHeader>
          <CardTitle>Advanced Screening List </CardTitle>
        </CardHeader>
