...
class AdminDashboard extends React.Component {
  ...
  getAdvancedScr(){
    axios.post('http://127.0.0.1:3010/api/generalsurvey/screeningScreenerCount',{ngoId:localStorage.getItem('ngoId')})
.then(response => {
...
.catch(e=>{
 ...
 // }
  ...
  getPendingSevika(){
     axios.post('http://127.0.0.1:3010/api/generalsurvey/screeningSevikaCount',{ngoId:localStorage.getItem('ngoId')})
 .then(response => {
 ...
 .catch(e=>{
  ...
  axios.post('http://127.0.0.1:3010/api/graph/getlist', {ngoId:localStorage.getItem('ngoId'),token:'dfjkhsdfaksjfh3756237', ngoLoginId:localStorage.getItem('ngoId')})
   .then(response => {
...
//   axios.post('http://127.0.0.1:3010/api/screening/getCaseDetails')
//   .then(response => {
...
//  axios.post('http://127.0.0.1:3010/api/screening/getCaseDetails',{status:'2'})
//  .then(response => {
...
// axios.post('http://127.0.0.1:3010/api/screening/getCaseDetails', {status:'1'})
//  .then(response => {
...
//   axios.post('http://127.0.0.1:3010/api/citizen/citizenRefercount')
//   .then(response => {
...
//  axios.post('http://127.0.0.1:3010/api/citizen/citizenPrescribeCount')
//   .then(response => {
