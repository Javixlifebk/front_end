...
class AdminDashboard extends React.Component {
  ...
  axios.post('http://159.65.148.197:3010/api/screening/getCaseDetails')
  .then(response => {
 ...
 axios.post('http://159.65.148.197:3010/api/screening/getCaseDetails',{status:'2'})
 .then(response => {
...
axios.post('http://159.65.148.197:3010/api/screening/getCaseDetails', {status:'1'})
 .then(response => {
