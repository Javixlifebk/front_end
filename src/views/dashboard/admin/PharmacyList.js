...
componentDidMount() {
		...
		//this.setState({data:null});
		  axios.post('http://18.60.238.252:3010/api/pharmacy/pharmacyList', {userId:'rahulpandeyjaiho@gmail.com',token:"dfjkhsdfaksjfh3756237", ngoId:localStorage.getItem("ngoId")})
		 .then(response => {
