...
componentDidMount() {
		...
		//this.setState({data:null});
		  axios.post('http://javixlife.org:3010/api/doctor/doctorList', {userId:'rahulpandeyjaiho@gmail.com',token:"dfjkhsdfaksjfh3756237",ngoId:localStorage.getItem("ngoId")})
		 .then(response => {
