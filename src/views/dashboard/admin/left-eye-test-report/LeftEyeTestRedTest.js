...
const fetchRecords = (page,size) => {
  axios.post("https://javixlife.org/api/labtest/getLeftEyeRedList" ,{
    "pageNo":page,
    "size":size,
...
const filterData = (data) =>
    ...
    const setBP=(leye)=>{
      return(<span style={{background:'red',padding:'4px',color:'white'}}>Left Eye:{leye}</span>);
    }
   ...
   const  getCitizenScreener=(_screenerId) =>{
    ...
    return (
      <>
       <Row>
      <Col sm="12">
      <CardTitle><b><h3>Left Eye Red Cases</h3></b> </CardTitle>
      </Col>          
      </Row>
