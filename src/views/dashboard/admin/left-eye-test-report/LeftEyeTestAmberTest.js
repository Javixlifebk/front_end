...
const fetchRecords = (page,size) => {
  axios.post("https://javixlife.org/api/labtest/getLeftEyeAmberList" ,{
    "pageNo":page,
    "size":size,
...
const filterData = (data) =>
    ...
    const setBP=(leye)=>{
          return(<span style={{background:'#FFBF00',padding:'4px',color:'white'}}>Left Eye:{leye}</span>);
    }
   ...
   const  getCitizenScreener=(_screenerId) =>{
    ...
    return (
      <>
       <Row>
      <Col sm="12">
      <CardTitle><b><h3>Left Eye Amber Cases</h3></b> </CardTitle>
      </Col>          
      </Row>
