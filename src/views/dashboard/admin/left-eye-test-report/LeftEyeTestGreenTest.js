...
const fetchRecords = (page,size) => {
  axios.post("https://javixlife.org/api/labtest/getLeftEyeGreenList" ,{
    "pageNo":page,
    "size":size,
...
const filterData = (data) =>
    ...
    const setBP=(leye)=>{
      return(<span style={{background:'#008000',padding:'4px',color:'white'}}>Left Eye:{leye}</span>);
    }
   ...
   const  getCitizenScreener=(_screenerId) =>{
    ...
    },
    {
      ...
      },
      {
        ...
        render: (_, record) => (
          ...
          <span style={{margin:'20px;',padding:'4px;'}}>{setBP(record.leye)}</span>&nbsp;&nbsp;
          </p>
          </div>
        ),
      },
    ...
    return (
      <>
       <Row>
      <Col sm="12">
      <CardTitle><b><h3>Left Eye Green Cases</h3></b> </CardTitle>
      </Col>          
      </Row>
