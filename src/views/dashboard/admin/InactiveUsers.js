...
handleClick(_userid) {
  ...
  let _targetPostURL="http://143.244.136.145:3001/api/auth/approve?=";
  axios(
    {
      method: 'post',
      url: _targetPostURL,
...
componentDidMount() {
		...
		//this.setState({data:null});
		  axios.post('http://143.244.136.145:3001/api/auth/authlist', {email:'jilani.it@gmail.com',status:0 })
		 .then(response => {
  ...
  render() {
    ...
    return (
      <Card>
        <CardHeader>
          <CardTitle>Inactive User List</CardTitle>
        </CardHeader>
