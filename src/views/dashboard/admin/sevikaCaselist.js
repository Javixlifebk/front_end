...
componentDidMount() {
		...
		//this.setState({data:null});
		 ...
		 axios.post("http://javixlife.org:3010/api/generalsurvey/screeningScreener",{ngoId:localStorage.getItem("ngoId")})
    //  http://javixlife.org:3010/api/generalsurvey/screenersevika
		 .then(response => {
