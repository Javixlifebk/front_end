...
const fetchRecords = (page,size) => {
  axios.post("https://javixlife.org/api/labtest/getTempratureGreenList" ,{
    "pageNo":page,
    "size":size,
...
const filterData = (data) =>
    ...
    const setBP =(hemoglobin)=>{
      ...
      if(hemoglobin<14 && hemoglobin>18){
          return(<span style={{background:'#008000',padding:'4px',color:'white',borderRadius:'25px;'}}>Temprature:{hemoglobin}</span>);
       }else{
          return(<span style={{background:'#008000',padding:'4px',color:'white'}}>Temprature:{hemoglobin}</span>);
       }
  }
   const  getCitizenScreener=(_screenerId) =>{
    ...
    return (
      <>
       <Row>
      <Col sm="12">
      <CardTitle><b><h3>Temprature Green Cases</h3></b> </CardTitle>
      </Col>          
      </Row>
