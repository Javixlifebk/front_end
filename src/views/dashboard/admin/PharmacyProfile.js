...
class Profile extends React.Component {
  ...
  handleBack() {    
    window.location='../../views/dashboard/pharmacylist'
  }
  ...
  componentDidMount() {console.log("DID MOUNT ************");
		...
		axios.post('http://159.65.148.197:3001/api/pharmacy/pharmacyById?=', { userId: localStorage.getItem("Phid"),token:'dfjkhsdfaksjfh3756237' })
		 .then(response => {
