...
class Profile extends React.Component {
  ...
  handleBack() {    
    window.location='/dashboard/pharmacylist'
  }
  ...
  componentDidMount() {
		...
		axios.post('http://159.65.148.197:3010/api/pharmacy/pharmacyById?=', { userId: localStorage.getItem("Phid"),token:'dfjkhsdfaksjfh3756237' })
		 .then(response => {
