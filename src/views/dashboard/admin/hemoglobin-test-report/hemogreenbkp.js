...
componentDidMount() {
    ...
    // if(localStorage.getItem("severity")==="1"){
		  ...
		  axios.post('https://javixlife.org:3010/api/labtest/getHemoglobinGreenList')
		 .then(response => {
    ...
    //   axios.post('https://javixlife.org:3010/api/labtest/getBloodGlucoseTestList', {severity:0})
    //   .then(response => {
    //     
    //        if(response.data.status===1)
    //          {
    ...
    //   axios.post('https://javixlife.org:3010/api/labtest/getBloodGlucoseTestList', {severity:2})
    //   .then(response => {
