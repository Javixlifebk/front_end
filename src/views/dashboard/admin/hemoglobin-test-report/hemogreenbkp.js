...
componentDidMount() {
    ...
    // if(localStorage.getItem("severity")==="1"){
		  ...
		  axios.post('http://127.0.0.1:3010/api/labtest/getHemoglobinGreenList')
		 .then(response => {
    ...
    //   axios.post('http://127.0.0.1:3010/api/labtest/getBloodGlucoseTestList', {severity:0})
    //   .then(response => {
    //     
    //        if(response.data.status===1)
    //          {
    ...
    //   axios.post('http://127.0.0.1:3010/api/labtest/getBloodGlucoseTestList', {severity:2})
    //   .then(response => {
