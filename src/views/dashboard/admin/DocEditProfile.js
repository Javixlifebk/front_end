...
componentDidMount() {
		...
		//this.setState({data:null});
		  ...
		  axios.post('http://143.244.136.145:3001/api/doctor/doctorById?=', {userId:localStorage.getItem("Docid"),token:'dfjkhsdfaksjfh3756237'})
		 .then(response => {
  ...
  handleSubmit = e => {
    e.preventDefault()   
      ...
      let _targetPostURL="http://143.244.136.145:3001/api/doctor/addprofile?=";
      axios(
        {
          method: 'post',
          url: _targetPostURL,
