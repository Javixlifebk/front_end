...
findDataById(){
  ...
  axios.post('http://127.0.0.1:3010/api/doctor/doctorListById',{"doctorLoginId":localStorage.getItem("userid")})
  .then(response => {
    if(response){
...
componentDidMount() {
  ...
  alert(localStorage.getItem("userid"))
		...
		//   axios.post('http://127.0.0.1:3010/api/doctor/doctorById?=', {userId:localStorage.getItem("Docid"),token:'dfjkhsdfaksjfh3756237'})
		//  .then(response => {
...
// }
  handleSubmit = e => {
    e.preventDefault()   
      ...
      let _targetPostURL="http://127.0.0.1:3010/api/doctor/addprofile?=";
      axios(
        {
          method: 'post',
          url: _targetPostURL,
