...
class DocEditProfile extends React.Component {
  state = {
    fname:'',
    lname:'',
    gender:'',
...
findDataById(){
  ...
  axios.post('http://18.60.238.252:3010/api/doctor/doctorListById',{"doctorLoginId":localStorage.getItem("userid")})
  .then(response => {
    if(response){
...
componentDidMount() {
  ...
  alert(localStorage.getItem("userid"))
		...
		//   axios.post('http://18.60.238.252:3010/api/doctor/doctorById?=', {userId:localStorage.getItem("Docid"),token:'dfjkhsdfaksjfh3756237'})
		//  .then(response => {
...
// }
  handleSubmit = e => {
    e.preventDefault()   
      ...
      let _targetPostURL="http://18.60.238.252:3010/api/doctor/addprofile?=";
      axios(
        {
          method: 'post',
          url: _targetPostURL,
        ...
        <Form action="/" onSubmit={this.handleSubmit}>
            ...
            <Col sm="6">
              ...
              <Col sm="2">
                ...
                className="React"
                isOptionSelected={this.state.gender}
