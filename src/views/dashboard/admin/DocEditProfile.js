...
findDataById(){
  ...
  axios.post('https://javixlife.org/api/doctor/doctorListById',{"doctorLoginId":localStorage.getItem("userid")})
  .then(response => {
    if(response){
...
componentDidMount() {
  ...
  alert(localStorage.getItem("userid"))
		...
		//   axios.post('https://javixlife.org/api/doctor/doctorById?=', {userId:localStorage.getItem("Docid"),token:'dfjkhsdfaksjfh3756237'})
		//  .then(response => {
...
// }
  handleSubmit = e => {
    e.preventDefault()   
      ...
      let _targetPostURL="https://javixlife.org/api/doctor/addprofile?=";
      axios(
        {
          method: 'post',
          url: _targetPostURL,
