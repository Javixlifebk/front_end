...
class Profile extends React.Component {
  ...
  handleChangePwd() {
    ...
    let _targetPostURL="http://127.0.0.1:3010/api/auth/forgotpw?=";    
    axios(
      {
        method: 'post',
        url: _targetPostURL,
  ...
  componentDidMount() {
		...
		//this.setState({data:null});
		  ...
		  axios.post('http://127.0.0.1:3010/api/doctor/doctorById?=162480116265360010', {userId:localStorage.getItem("Docid"),token:'dfjkhsdfaksjfh3756237'})
		 .then(response => {
