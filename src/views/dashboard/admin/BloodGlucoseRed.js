...
class BloodGlucoseRed extends React.Component {
...
componentDidMount() {
    ...
    // if(localStorage.getItem("severity")==="1"){
		  ...
		  axios.post('http://159.65.148.197:3010/api/labtest/getBloodGlucoseRedList')
		 .then(response => {
    ...
    return (
      ...
      <Card>
        ...
        <Row>
          ...
          <CardTitle>Blood Glucose Red Cases</CardTitle>
...
export default BloodGlucoseRed;
