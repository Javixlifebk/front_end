...
class Profile extends React.Component {
  ...
  getImage(){
    if(this.state.imagurl===''){
      this.state.imagurl='http://159.65.148.197:3010/profile/no-photo-male.jpg';
    }
  ...
  componentDidMount() {
		...
		axios.post('http://159.65.148.197:3010/api/ngo/screenerById?=', { userId:localStorage.getItem("userid"),token:'dfjkhsdfaksjfh3756237' })
		 .then(response => {
