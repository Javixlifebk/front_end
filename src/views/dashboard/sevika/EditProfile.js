...
class EditProfile extends React.Component {
  ...
  findDataById(){
    ...
    axios.post('http://localhost:3010/api/ngo/sevikaListById',{"screenerLoginId":localStorage.getItem("userid")})
    .then(response => {
      if(response){
  ...
  handleSubmit = e => {
    e.preventDefault()   
      ...
      let _targetPostURL="http://localhost:3010/api/ngo/screener/addprofile?=";
      axios(
        {
          method: 'post',
          url: _targetPostURL,
