...
class EditProfile extends React.Component {
  ...
  findDataById(){
    ...
    axios.post('http://18.60.238.252:3010/api/ngo/sevikaListById',{"screenerLoginId":localStorage.getItem("userid")})
    .then(response => {
      if(response){
  ...
  handleSubmit = e => {
    e.preventDefault()   
      ...
      let _targetPostURL="http://18.60.238.252:3010/api/ngo/screener/addprofile?=";
      axios(
        {
          method: 'post',
          url: _targetPostURL,
      ...
      <Card >
        ...
        <Form action="/" onSubmit={this.handleSubmit}>
            ...
            <Col sm="6">
              ...
              <Col sm="12">
                <FormGroup>
                  <Label for="EmailVertical">Sevika Address</Label>                 
                  <Input
                    type="textarea"
