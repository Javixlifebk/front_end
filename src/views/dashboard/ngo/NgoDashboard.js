...
class NgoDashboard extends React.Component {
  ...
  getAdvancedScr(){
    axios.post('https://javixlife.org:3010/api/generalsurvey/screeningScreenerCount',{ngoId:localStorage.getItem("userid")})
.then(response => {
...
.catch(e=>{
 ...
 // }
  ...
  getPendingSevika(){
     axios.post('https://javixlife.org:3010/api/generalsurvey/screeningSevikaCount',{ngoId:localStorage.getItem("userid")})
 .then(response => {
 ...
 .catch(e=>{
  ...
  axios.post('https://javixlife.org:3010/api/graph/getlist', { ngoId:localStorage.getItem("userid"),token:'dfjkhsdfaksjfh3756237' })
   .then(response => {
