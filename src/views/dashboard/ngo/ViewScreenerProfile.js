...
class Profile extends React.Component {
  ...
  componentDidMount() {
		...
		axios.post('http://javixlife.org:3010/api/ngo/screenerById?=', { screenerId:localStorage.getItem("Scrid"),token:'dfjkhsdfaksjfh3756237' })
		 .then(response => {
 ...
 if(window.confirm("Do you want to map screener !")){
  ...
  //http://javixlife.org:3010/api/ngo/screener/updateScreenerNgoId
  //alert('okay')
  //window.location='../../views/dashboard/screditprofile'
          ...
          let _targetPostURL="http://javixlife.org:3010/api/ngo/screener/updateScreenerNgoId?=";
          axios(
          {
          method: 'post',
          url: _targetPostURL,
