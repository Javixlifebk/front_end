...
loadRecs(recs)
 ...
 handleClick(doctorId) {
  ...
  let _targetPostURL="http://localhost:3001/api/doctor/updatemapped?=";
  axios(
    {
      method: 'post',
      url: _targetPostURL,
...
componentDidMount() {console.log("DID MOUNT ************");
    ...
    axios.post('http://localhost:3001/api/doctor/unmappedList', {token:'dfjkhsdfaksjfh3756237',ismapped:false })
		 .then(response => {
