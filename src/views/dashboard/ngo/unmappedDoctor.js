...
loadRecs(recs)
 ...
 handleClick(doctorId) {
  ...
  let _targetPostURL="http://143.244.136.145:3001/api/doctor/updatemapped?=";
  axios(
    {
      method: 'post',
      url: _targetPostURL,
...
componentDidMount() {
		...
		//axios.post('http://143.244.136.145:3001/api/ngo/screenerList', { userId: '4632746328',ngoId:'0',token:'dfjkhsdfaksjfh3756237' })
    axios.post('http://143.244.136.145:3001/api/doctor/unmappedList', {token:'dfjkhsdfaksjfh3756237',ismapped:false })
		 .then(response => {
...
handleSubmit = e => {
  ...
  render() {
    ...
    return (
      <Card>
        <CardHeader>
          <CardTitle>Unmapped Doctor List</CardTitle>
        </CardHeader>
