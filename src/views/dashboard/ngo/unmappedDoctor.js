...
handleClick(doctorId) {
  ...
  if (window.confirm("Are you sure you want to map the Doctor ?")) {
    ...
    const targetPostURL = "http://localhost:3010/api/doctor/updatemapped";
...
componentDidMount() {
    ...
    axios.post('http://localhost:3010/api/doctor/unmappedList', {token:'dfjkhsdfaksjfh3756237',ngoId:'0' })
		 .then(response => {
