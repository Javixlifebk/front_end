...
loadRecs(recs)
 ...
 handleClick(doctorId) {
  ...
  let _targetPostURL="http://159.65.148.197:3010/api/doctor/updatemapped?=";
  axios(
    {
      method: 'post',
      url: _targetPostURL,
...
componentDidMount() {
		...
		//axios.post('http://159.65.148.197:3010/api/ngo/screenerList', { userId: '4632746328',ngoId:'0',token:'dfjkhsdfaksjfh3756237' })
    axios.post('http://159.65.148.197:3010/api/doctor/unmappedList', {token:'dfjkhsdfaksjfh3756237',ismapped:false })
		 .then(response => {
