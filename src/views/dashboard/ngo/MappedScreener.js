...
loadRecs(recs)
 ...
 handleClick(screenerId) {
  ...
  // let _targetPostURL="http://localhost:3010/api/ngo/updatescreenermap?=";
  axios.post('http://localhost:3010/api/ngo/updatescreenermap?=', {screenerId:screenerId ,token:'dfjkhsdfaksjfh3756237',ngoId:"0"})
  .then(res=>{
...
componentDidMount() {
    ...
    const userId=localStorage.getItem("userId")
		//axios.post('http://localhost:3010/api/ngo/screenerList', { userId: '4632746328',ngoId:'0',token:'dfjkhsdfaksjfh3756237' })
    axios.post('http://localhost:3010/api/ngo/screenermappedlist', {ngoId:localStorage.getItem("userid") ,token:'dfjkhsdfaksjfh3756237',issubscreener:0})
		 .then(response => {
