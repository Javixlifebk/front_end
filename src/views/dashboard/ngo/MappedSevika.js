...
componentDidMount() {
    ...
    console.log("userId====",localStorage.getItem("userId"));
		...
		// axios.post('https://javixlife.org:3010/api/ngo/screenerList', { userId: '4632746328', ngoId:0 ,token:'dfjkhsdfaksjfh3756237',ismapped:true })
    axios.post('https://javixlife.org:3010/api/ngo/sevikamappedlist', {ngoId: userId,token:'dfjkhsdfaksjfh3756237',issubscreener:1})
