...
loadRecs(recs)
 ...
 handleClick(screenerId) {
  ...
  let _targetPostURL="http://143.244.136.145:3001/api/ngo/updatescreenermap?=";
  axios(
    {
      method: 'post',
      url: _targetPostURL,
...
componentDidMount() {
    ...
    axios.post('http://143.244.136.145:3001/api/ngo/screenerunmappedlist', {token:'dfjkhsdfaksjfh3756237',issubscreener:0,ismapped:false})
		 .then(response => {
