...
handleClick(screenerId) {
  ...
  if (window.confirm("Are you sure you want to map the screener?")) {
    ...
    const postData = {
      ...
      const targetPostURL = "https://javixlife.org:3010/api/ngo/updatescreenermap";
...
componentDidMount() {
    ...
    axios.post('https://javixlife.org:3010/api/ngo/screenerunmappedlist', {token:'dfjkhsdfaksjfh3756237',issubscreener:0,ngoId:"0"})
		 .then(response => {
