...
loadRecs(recs)
 ...
 handleClick(screenerId) {
  ...
  let _targetPostURL="http://159.65.148.197:3010/api/ngo/updatescreenermap?=";
  axios(
    {
      method: 'post',
      url: _targetPostURL,
...
componentDidMount() {
    ...
    axios.post('http://159.65.148.197:3010/api/ngo/screenerunmappedlist', {token:'dfjkhsdfaksjfh3756237',issubscreener:0,ismapped:false})
		 .then(response => {
