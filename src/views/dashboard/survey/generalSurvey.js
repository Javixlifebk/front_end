...
// const searchdata=()=>{
//   axios.post('http://127.0.0.1:3010/api/generalsurvey/GeneralSurveyList')
//  .then(response => {
...
// }
// const urlexport="http://127.0.0.1:3010/exports/csv-generalsurvey.csv"
// console.log("+++++++",selectedFilter)
const setexportdata=()=>{
  // fetch('http://127.0.0.1:3010/api/generalsurvey/download',urlexport)
  axios.get('http://127.0.0.1:3010/api/generalsurvey/download',{ngoId: localStorage.getItem("ngoId"),})
   .then(response => {
...
// alert("urlexport");
  ...
  useEffect(() => {
		  ...
		  axios.post('http://127.0.0.1:3010/api/generalsurvey/GeneralSurveyList', { ngoId:(localStorage.getItem("ngoId")) ? localStorage.getItem("ngoId") : localStorage.getItem("userid")})
		 .then(response => {
					if(response.data.status===1)
					  {
						  var recs=response.data.data.data;
  ...
  return (
    ...
    <div className="bannermain">
      ...
      <Button.Ripple
                    ...
                    href="http://127.0.0.1:3010/exports/csv-generalsurvey.csv"
