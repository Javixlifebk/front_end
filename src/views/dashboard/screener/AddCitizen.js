...
//   axios.post('https://javixlife.org:3010/api/ngo/screenerListById',{screenerId:localStorage.getItem("screenerId")})
//   .then(response => {
//     if(response){
...
componentDidMount(){
  ...
  handleSubmit = e => {
    ...
    .then(res => {
        ...
        let _targetPostURL="https://javixlife.org:3010/api/citizen/addprofile";
        axios(
          {
            method: 'post',
            url: _targetPostURL,
