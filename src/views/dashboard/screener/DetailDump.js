...
class JTable extends React.Component {
    ...
    getDailyScreeningScreener() {
        axios.post('http://javixlife.org:3010/api/report/ScreeningScreenerCsv', {
    ...
    getdailycitizenReport() {
        axios.post('http://javixlife.org:3010/api/report/createCitizenCsv', {
            ngoId: (localStorage.getItem("ngoId")) ? localStorage.getItem("ngoId") : localStorage.getItem("userid")
        }).then(response => {
    ...
    getweekcitizenReport() {
        axios.post('http://javixlife.org:3010/api/report/createWeeklyCitizencsv', {
            ngoId: (localStorage.getItem("ngoId")) ? localStorage.getItem("ngoId") : localStorage.getItem("userid")
        }).then(response => {
    ...
    getdailycitizendetailReport() {
        axios.post('http://javixlife.org:3010/api/report/createCitizenDetailCsv', {
            ngoId: (localStorage.getItem("ngoId")) ? localStorage.getItem("ngoId") : localStorage.getItem("userid")
        }).then(response => {
    ...
    getweekcitizendetailReport() {
        axios.post('http://javixlife.org:3010/api/report/weeklyCitizenDetailcsv', {
            ngoId: (localStorage.getItem("ngoId")) ? localStorage.getItem("ngoId") : localStorage.getItem("userid")
        }).then(response => {
    ...
    getsevikaReport() {
        axios.post('http://javixlife.org:3010/api/report/ScreeningSevikaCsv', {
            ngoId: (localStorage.getItem("ngoId")) ? localStorage.getItem("ngoId") : localStorage.getItem("userid")
        }).then(response => {
    ...
    getLipidCriticalCitizens() {
        axios.post('http://javixlife.org:3010/api/report/lipidCriticalCitizensDetailcsv', {
            ngoId: (localStorage.getItem("ngoId")) ? localStorage.getItem("ngoId") : localStorage.getItem("userid")
        }).then(response => {
            window.open("http://javixlife.org:3010/exports/csv-lipidCriticalCitizensDetail.csv")
        }).catch(e => {});
    }

    getUnscreenedCitizenDetailcsv() {
        axios.post('http://javixlife.org:3010/api/report/unscreenedCitizenDetailcsv', {
            ngoId: (localStorage.getItem("ngoId")) ? localStorage.getItem("ngoId") : localStorage.getItem("userid")
        }).then(response => {
            window.open("http://javixlife.org:3010/exports/csv-unscreenedCitizenDetailcsv.csv")
        }).catch(e => {});
    }

    generalSurveyCSV() {
        axios.post('http://javixlife.org:3010/api/report/generalSurveyCSV', {
            ngoId: (localStorage.getItem("ngoId")) ? localStorage.getItem("ngoId") : localStorage.getItem("userid")
        }).then(response => {
            window.open("http://javixlife.org:3010/exports/csv-generalSurveyCSV.csv")
        }).catch(e => {});
    }

    healthSurveyCSV() {
        axios.post('http://javixlife.org:3010/api/report/healthSurveyCSV', {
            ngoId: (localStorage.getItem("ngoId")) ? localStorage.getItem("ngoId") : localStorage.getItem("userid")
        }).then(response => {
            window.open("http://javixlife.org:3010/exports/csv-healthSurveyCSV.csv")
        }).catch(e => {});
    }

    socioEconomicSurveyCSV() {
        axios.post('http://javixlife.org:3010/api/report/socioEconomicSurveyCSV', {
            ngoId: (localStorage.getItem("ngoId")) ? localStorage.getItem("ngoId") : localStorage.getItem("userid")
        }).then(response => {
            window.open("http://javixlife.org:3010/exports/csv-socioEconomicSurveyCSV.csv")
        }).catch(e => {});
    }
    componentDidMount() {
        this.mounted = true;
