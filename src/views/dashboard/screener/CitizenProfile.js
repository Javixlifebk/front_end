...
class CitizenProfile extends React.Component {
  ...
  componentDidMount() {
		...
		axios.post('http://143.244.136.145:3010/api/citizen/citizenById?=', { citizenId:localStorage.getItem("citizenId"),token:'dfjkhsdfaksjfh3756237' })
		 .then(response => {
      if(response.data.status===1){
        var recs=response.data.data.data;
          ...
          this.setState({citizenId:recs[0].citizenId});
          this.setState({aadhaar:recs[0].aadhaar});       
 ...
 if(window.confirm("Do you want to edit your profile !")){
  ...
  render() {
    ...
    <Card>
        <CardHeader>
          <CardTitle>Citizen's Profile</CardTitle>
        ...
        <Row>
            ...
            <Col sm="8">
                ...
                <Row>
                    <Col sm="4">
                    <div className="mt-1">
                    <h6 className="mb-0">Aadhaar No:</h6>
