...
class ScreenerDashboard extends React.Component {
  ...
  axios.post('http://127.0.0.1:3010/api/graph/getlist', {token:'dfjkhsdfaksjfh3756237',ngoId:localStorage.getItem("ngoId") ,userId:localStorage.getItem("userid"), ngoLoginId:localStorage.getItem('ngoId')})
   .then(response => {
