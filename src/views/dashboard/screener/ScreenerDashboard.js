...
class ScreenerDashboard extends React.Component {
  ...
  axios.post('https://javixlife.org/api/graph/getlist', {token:'dfjkhsdfaksjfh3756237',ngoId:localStorage.getItem("ngoId") ,userId:localStorage.getItem("userid"), ngoLoginId:localStorage.getItem('ngoId')})
   .then(response => {
