...
componentDidMount() {
		...
		let scrId=localStorage.getItem("_screenerId");
		  axios.post('http://143.244.136.145:3001/api/citizen/citizenList?', {token:'dfjkhsdfaksjfh3756237',screenerId:scrId })
		 .then(response => {
  ...
  callSearch=_v=>{
		...
		//this.setState({data:null});
		  axios.post('http://143.244.136.145:3001/api/citizen/citizenList100?', {token:'dfjkhsdfaksjfh3756237',v:_v })
		 .then(response => {
