...
componentDidMount() {
		...
		let scrId=localStorage.getItem("_screenerId");
		  axios.post('http://18.60.238.252:3010/api/citizen/citizenList?', {token:'dfjkhsdfaksjfh3756237',screenerId:scrId })
		 .then(response => {
  ...
  callSearch=_v=>{
		...
		//this.setState({data:null});
		  axios.post('http://18.60.238.252:3010/api/citizen/citizenListPagination?', {token:'dfjkhsdfaksjfh3756237',v:_v ,'isUnrefer':0,})
		 .then(response => {
